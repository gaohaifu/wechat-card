...
class Agreement extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $playerList = $this->auth->getPlayer();
        $player = $playerList ? array_values($playerList) : [];
        $this->view->assign("player", json_encode($player));
    ...
    public function del($ids = null)
    {
        ...
        if ($ids) {
            ...
            $this->model->where('company_id', COMPANY_ID)->where('status', 'in', ['hidden', 'expired']);
