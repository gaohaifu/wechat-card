 ...
 */
class Companyadmin extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\smartcard\Companyadmin;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $list = $this->model
                ->with(['ckdcompany','ckdadministrators'])
                ->where($where)
                ->where('companyadmin.id', 'in', $this->childrenAdminIds)
