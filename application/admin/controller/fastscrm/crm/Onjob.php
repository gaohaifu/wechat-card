 ...
 * @icon fa fa-circle-o
 */
class Onjob extends Backend
{

    /**
     * Onjob模型对象
     * @var \app\admin\model\fastscrm\crm\Onjob
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\fastscrm\crm\Onjob;
            ...
            if ($params) {
                ...
                if (!empty($params['customers'])) {
                    ...
                    foreach ($customers as $customer) {
                        \app\admin\model\fastscrm\crm\Onjobcustomer::insert([
                            'onjob_id' => $id,
                ...
                if (!empty($params['chats'])) {
                    ...
                    foreach ($chats as $chat) {
                        \app\admin\model\fastscrm\crm\Onjobchat::insert([
                            'onjob_id' => $id,
                            'chat_id' => $chat,
                            'createtime' => time()
                        ]);
    ...
    public function action($ids)
    {
        ...
        if($row->type=='customer'){
            $param['task'] = 'onJobCustomer';
        }else{
            $param['task'] = 'onJobChat';
        }
