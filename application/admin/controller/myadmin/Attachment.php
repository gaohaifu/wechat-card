...
class Attachment extends Backend
{
    ...
    /**
     * @var \addons\myadmin\model\Attachment
     */
    protected $model = null;

    protected $searchFields = 'company.name,filename,url';
    ...
    public function _initialize()
    {
        ...
        $upload['multipart']['company_id'] = 'common';
        ...
        $this->model = new \addons\myadmin\model\Attachment;
        $this->view->assign("mimetypeList", \addons\myadmin\model\Attachment::getMimetypeList());
        $this->view->assign("categoryList", \addons\myadmin\model\Attachment::getCategoryList());
        $this->assignconfig("categoryList", \addons\myadmin\model\Attachment::getCategoryList());
    }
    ...
    public function upload()
    {
        ...
        return action('myadmin/ajax/upload');
    }
    ...
    {
        if (!$this->auth->check('myadmin/attachment/edit')) {
        ...
        $categoryList = \addons\myadmin\model\Attachment::getCategoryList();
        if ($category && !isset($categoryList[$category])) {
            $this->error(__('Category not found'));
        }
        $category = $category == 'unclassed' ? '' : $category;
        \addons\myadmin\model\Attachment::where('id', 'in', $ids)->update(['category' => $category]);
        $this->success();
    }
