...
class Xccmssiteconfig extends Backend
{
    ...
    public function index()
    {
        if (false === $this->request->isPost()) {
            ...
            //初始化一个站点菜单
            if (Xccmsmenuinfo::count() == 0)
            {
                $temp_data = [
                    ['parent_id'=>0, 'name'=>'首页', 'en_name'=>'HOME', 'menu_type'=>'index', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>99, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['parent_id'=>0, 'name'=>'新闻资讯', 'en_name'=>'NEWS', 'menu_type'=>'news', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>98, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['parent_id'=>0, 'name'=>'关于我们', 'en_name'=>'ABOUT', 'menu_type'=>'aboutus', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>0, 'is_bottom_show'=>1, 'state'=>1, 'weigh'=>97, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['parent_id'=>0, 'name'=>'联系我们', 'en_name'=>'CONTACT', 'menu_type'=>'contactus', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>0, 'is_bottom_show'=>1, 'state'=>1, 'weigh'=>96, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['parent_id'=>0, 'name'=>'合作伙伴', 'en_name'=>'PARTNER', 'menu_type'=>'partner', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>1, 'state'=>1, 'weigh'=>95, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['parent_id'=>0, 'name'=>'在线招聘', 'en_name'=>'JOB', 'menu_type'=>'job', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>1, 'state'=>1, 'weigh'=>94, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['parent_id'=>0, 'name'=>'FAQ', 'en_name'=>'FAQ', 'menu_type'=>'faq', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>0, 'is_bottom_show'=>1, 'state'=>1, 'weigh'=>93, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                ];
            ...
            //初始化轮播
            if (Xccmswebsitecarousel::count() == 0)
            {
                $temp_data = [
                    ['title'=>'演示轮播1', 'list_image'=>'/assets/addons/xccms/img/test-carousel.png', 'weigh'=>10, 'state'=>1, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0],
                    ['title'=>'演示轮播2', 'list_image'=>'/assets/addons/xccms/img/test-carousel.png', 'weigh'=>9, 'state'=>1, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0]
                ];
    ...
    private function add_menu_product_category()
    {
        ...
        $parent_menu_id = Xccmsmenuinfo::insertGetId(['parent_id'=>0, 'name'=>'产品中心', 'en_name'=>'PRODUCT', 'menu_type'=>'link', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>93, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0]);
        Xccmsmenuinfo::insert(['parent_id'=>$parent_menu_id, 'name'=>'产品分类1', 'en_name'=>'', 'menu_type'=>'product', 'menu_object_id'=>$category_id, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>99, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0]);
    ...
    private function add_menu_content_category()
    {
        ...
        $parent_menu_id = Xccmsmenuinfo::insertGetId(['parent_id'=>0, 'name'=>'内容中心', 'en_name'=>'CONTENT', 'menu_type'=>'link', 'menu_object_id'=>0, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>92, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0]);
        Xccmsmenuinfo::insert(['parent_id'=>$parent_menu_id, 'name'=>'内容分类1', 'en_name'=>'', 'menu_type'=>'content', 'menu_object_id'=>$category_id, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>99, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0]);
    }
    ...
    private function add_menu_page()
    {
        ...
        Xccmsmenuinfo::insert(['parent_id'=>0, 'name'=>'单页内容', 'en_name'=>'PAGE', 'menu_type'=>'page', 'menu_object_id'=>$page_info_id, 'url'=>'', 'is_top_show'=>1, 'is_bottom_show'=>0, 'state'=>1, 'weigh'=>91, 'createtime'=>time(), 'creator'=>0, 'updatetime'=>time(), 'updatedby'=>0]);
    }
