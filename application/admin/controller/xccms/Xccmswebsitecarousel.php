 ...
 * @icon fa fa-circle-o
 */
class Xccmswebsitecarousel extends Backend
{
    
    /**
     * Xccmswebsitecarousel模型对象
     * @var \app\admin\model\Xccmswebsitecarousel
     */
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\admin\model\Xccmswebsitecarousel;
