	...
	<view>
      ...
      <view class="Inside_fast Inside_fast_padding">
				<view class="infoItem flex_layout">
					<view class="left_title">商品名称</view>
					<view class="right_info flex_layout">
						<input type="text" v-model="name" placeholder="请填写商品名称" value="" />
					</view>
				</view>
				<view class="infoItem infoItem_textarea">
					<view class="left_title">商品详情</view>
					<view class="right_info flex_layout">
						<textarea v-model="maincontent" placeholder="请输入商品详情" />
					</view>
				</view>
				<view class="infoItem">
					<view class="left_title">商品图片</view>
		...
		<block v-if="status==1">
			<view class="sunmit_btn" @click="addSubmit">
				<button :style="{background:color}">新增商品</button>
			</view>
		</block>
		<block v-if="status==2">
			<view class="sunmit_btn" @click="editSubmit">
				<button :style="{background:color}">编辑商品</button>
			</view>
		</block>
	</view>
</template>
