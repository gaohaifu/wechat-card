	...
	export default {
		...
		methods: {
			addBtn(){
				var type='goods';
				uni.navigateTo({
					url:'/pages/company/addGoods?status=1'+'&company_id='+this.userData.company_id+'&type='+type
				})
			},
			edit(id){
				var type='goods';
				uni.navigateTo({
					url:'/pages/company/addGoods?id='+id+'&status=2'+'&company_id='+this.userData.company_id+'&type='+type
				})
			},
			companyInfoData(){
				this.reveal=false;
