...
<script>
	...
	export default {
		...
		methods: {
			addBtn(){
				uni.navigateTo({
					url:'/pages/company/addCase?status=1'+'&company_id='+this.userData.company_id+'&type=cases'
				})
			},
			edit(id){
				uni.navigateTo({
					url:'/pages/company/addCase?id='+id+'&status=2'+'&company_id='+this.userData.company_id+'&type=cases'
				})
			},
			companyInfoData(){
				this.reveal=false
