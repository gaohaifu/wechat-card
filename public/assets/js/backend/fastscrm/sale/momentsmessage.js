define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fastscrm/sale/momentsmessage/index' + location.search,
                    add_url: 'fastscrm/sale/momentsmessage/add',
                    edit_url: 'fastscrm/sale/momentsmessage/edit',
                    del_url: 'fastscrm/sale/momentsmessage/del',
                    multi_url: 'fastscrm/sale/momentsmessage/multi',
                    import_url: 'fastscrm/sale/momentsmessage/import',
                    table: 'fastscrm_moments_sale',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'item_id', title: __('Item_id'), operate: 'LIKE',searchList: $.getJSON("fastscrm/material/item/searchfind?field=row[id]"),formatter: Controller.api.formatter.item_total},
                        ...
                        {field: 'creater', title: '创建者',operate: false,  formatter: Controller.api.formatter.creatername},
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-leaf',
                                    confirm: '是否确认执行？',
                                    url: 'fastscrm/sale/momentsmessage/action',
                                ...
                                },
                                {
                                    ...
                                    title: __('效果分析'),
                                    text: '效果分析',
                                    classname: 'btn btn-xs btn-success btn-momentsreport',
            ...
            $(document).on("click", ".btn-momentsreport", function () {
                var index = $(this).data("row-index");
                var row = Table.api.getrowbyindex(table, index);
                var url = 'fastscrm/sale/momentsreport?sale_id='+row.id;
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'fastscrm/sale/momentsmessage/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'fastscrm/sale/momentsmessage/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'fastscrm/sale/momentsmessage/destroy',
                                    refresh: true
                                }
                            ],
                            formatter: Table.api.formatter.operate
        ...
        api: {
            ...
            formatter: {//渲染的方法
                ...
                item_total: function (value, row, index) {
                    if(row.item_total>0){
                        return row.item_total+'个附件';
                    }else{
                        return '-';
                    }
                },
                creatername: function (value, row, index) {
