define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fastscrm/crm/resigned/index' + location.search,
                    add_url: 'fastscrm/crm/resigned/add',
                    del_url: 'fastscrm/crm/resigned/del',
                    multi_url: 'fastscrm/crm/resigned/multi',
                    import_url: 'fastscrm/crm/resigned/import',
                    table: 'fastscrm_transfer_resigned',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    confirm: '是否确认执行？',
                                    url: 'fastscrm/crm/resigned/action',
                                ...
                                },
                                {
                                    ...
                                    confirm: '是否确认同步？',
                                    url: 'fastscrm/crm/resigned/sync',
            ...
            $(document).on("click", ".btn-customer", function () {
                ...
                var url = 'fastscrm/crm/resignedcustomer?resigned_id='+row.id;
                Backend.api.addtabs(url, '转移客户列表', '');
            });
            $(document).on("click", ".btn-chat", function () {
                var index = $(this).data("row-index");
                var row = Table.api.getrowbyindex(table, index);
                var url = 'fastscrm/crm/resignedchat?resigned_id='+row.id;
            ...
            new Vue({
                ...
                methods:{
                    ...
                    addHandoverWorkers:function () {
                        ...
                        var url = 'fastscrm/template/delWorkers?ids='+ids;
                        Fast.api.open(url,'选择离职员工',{
