define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'jstree'], function ($, undefined, Backend, Table, Form, undefined) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'myadmin/user.group/index',
                    add_url: 'myadmin/user.group/add',
                    edit_url: 'myadmin/user.group/edit',
                    del_url: 'myadmin/user.group/del',
                    multi_url: 'myadmin/user.group/multi',
                    table: 'user_group',
                }
            });
