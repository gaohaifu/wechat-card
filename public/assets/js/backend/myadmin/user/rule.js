define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'myadmin/user.rule/index',
                    add_url: 'myadmin/user.rule/add',
                    edit_url: 'myadmin/user.rule/edit',
                    del_url: 'myadmin/user.rule/del',
                    multi_url: 'myadmin/user.rule/multi',
                    table: 'user_rule',
                }
            });
