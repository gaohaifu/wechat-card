define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    "index_url": "myadmin/auth/rule/index",
                    "add_url": "myadmin/auth/rule/add",
                    "edit_url": "myadmin/auth/rule/edit",
                    "del_url": "myadmin/auth/rule/del",
                    "multi_url": "myadmin/auth/rule/multi",
                    "table": "auth_rule"
                }
            });
