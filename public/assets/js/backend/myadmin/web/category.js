define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'myadmin/web/category/index' + location.search,
                    add_url: 'myadmin/web/category/add' + (Config.type ? '/type/' + Config.type : '') + location.search,
                    edit_url: 'myadmin/web/category/edit',
                    del_url: 'myadmin/web/category/del',
                    multi_url: 'myadmin/web/category/multi',
                    import_url: 'myadmin/web/category/import',
                            ...
                            buttons: [
                                {
                                    ...
                                    url: function (table, row, index) {
                                        return 'myadmin/web/content/add?category_id=' + table['id'] + '&mould_id=' + table['mould_id'];
                                    }
                                }, {
                                    name: 'level',
                                    text: function (table, row, index) {
                                    ...
                                    url: function (table, row, index) {
                                        return 'myadmin/web/content/index?category_id=' + table['id'] + '&mould_id=' + table['mould_id'];
                                    },
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'myadmin/web/category/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            buttons: [{
                                ...
                                url: 'myadmin/web/category/restore',
                                refresh: true
                            },
                            {
                                name: 'Destroy',
                                ...
                                icon: 'fa fa-times',
                                url: 'myadmin/web/category/destroy',
                                refresh: true
                            }
                            ],
                            formatter: Table.api.formatter.operate
