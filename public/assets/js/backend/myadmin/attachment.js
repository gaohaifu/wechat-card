define(['jquery', 'bootstrap', 'backend', 'form', 'table'], function ($, undefined, Backend, Form, Table) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'myadmin/attachment/index',
                    add_url: 'myadmin/attachment/add',
                    edit_url: 'myadmin/attachment/edit',
                    del_url: 'myadmin/attachment/del',
                    multi_url: 'myadmin/attachment/multi',
                    table: 'company_attachment'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {
                            field: 'company_id', width: '120', title: __('Company'), visible: true,
                            align: 'left',
                            formatter: function (value, row, index) {
                                if (row.company.name) {
                                    return '<a href="javascript:;" class="searchit" data-field="company_id" data-value="' + row.company_id + '">' + row.company.name + '</a>';
                                }
                                return '<a href="javascript:;" class="searchit" data-field="company_id" data-value="0"><span class="text-danger"><i class="fa fa-circle"></i> 共同附件</span></a>';
                            }
                        },
            ...
            $(document).on('click', '.btn-classify', function () {
                ...
                Layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        Fast.api.ajax({
                            url: "myadmin/attachment/classify",
                            type: "post",
        ...
        select: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'myadmin/attachment/select',
                }
            });
            var urlArr = [];
        ...
        add: function () {
            ...
            // 获取企业ID
            $("#faupload-local,#faupload-local-chunking").data("company", function (file) {
                return $("#company").val();
            });
