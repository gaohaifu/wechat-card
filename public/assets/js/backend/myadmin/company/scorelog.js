define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function() {
            ...
            Table.api.init({
                extend: {
                    index_url: 'myadmin/company/scorelog/index',
                    add_url: 'myadmin/company/scorelog/add',
                    edit_url: 'myadmin/company/scorelog/edit',
                    del_url: 'myadmin/company/scorelog/del',
                    multi_url: 'myadmin/company/scorelog/multi',
