define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'smartcard/tags/index' + location.search,
                    add_url: 'smartcard/tags/add',
                    edit_url: 'smartcard/tags/edit',
                    del_url: 'smartcard/tags/del',
                    multi_url: 'smartcard/tags/multi',
                    import_url: 'smartcard/tags/import',
                    table: 'smartcard_tags',
                }
            });
