define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xccms/xccmspageinfo/index' + location.search,
                    add_url: 'xccms/xccmspageinfo/add',
                    edit_url: 'xccms/xccmspageinfo/edit',
                    del_url: 'xccms/xccmspageinfo/del',
                    table: 'xccms_page_info',
                }
            });
