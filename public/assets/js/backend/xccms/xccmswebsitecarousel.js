define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xccms/xccmswebsitecarousel/index' + location.search,
                    add_url: 'xccms/xccmswebsitecarousel/add',
                    edit_url: 'xccms/xccmswebsitecarousel/edit',
                    del_url: 'xccms/xccmswebsitecarousel/del',
                    table: 'xccms_website_carousel',
                }
            });
