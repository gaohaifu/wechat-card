define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xccms/xccmscontentcategory/index' + location.search,
                    add_url: 'xccms/xccmscontentcategory/add',
                    edit_url: 'xccms/xccmscontentcategory/edit',
                    del_url: 'xccms/xccmscontentcategory/del',
                    table: 'xccms_content_category',
                }
            });
