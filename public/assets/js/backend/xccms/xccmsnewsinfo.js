define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xccms/xccmsnewsinfo/index' + location.search,
                    add_url: 'xccms/xccmsnewsinfo/add',
                    edit_url: 'xccms/xccmsnewsinfo/edit',
                    del_url: 'xccms/xccmsnewsinfo/del',
                    table: 'xccms_news_info',
                }
            });
