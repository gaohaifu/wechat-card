define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fastscrm/sale/customermessage/index' + location.search,
                    add_url: 'fastscrm/sale/customermessage/add',
                    edit_url: 'fastscrm/sale/customermessage/edit',
                    del_url: 'fastscrm/sale/customermessage/del',
                    multi_url: 'fastscrm/sale/customermessage/multi',
                    import_url: 'fastscrm/sale/customermessage/import',
                    table: 'fastscrm_customer_sale',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-leaf',
                                    confirm: '是否确认执行？',
                                    url: 'fastscrm/sale/customermessage/action',
                                ...
                                },
                                {
                                    ...
                                    title: __('效果分析'),
                                    text: '效果分析',
                                    classname: 'btn btn-xs btn-success btn-customerreport',
            ...
            $(document).on("click", ".btn-customerreport", function () {
                var index = $(this).data("row-index");
                var row = Table.api.getrowbyindex(table, index);
                var url = 'fastscrm/sale/customerreport?sale_id='+row.id;
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'fastscrm/sale/customermessage/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'fastscrm/sale/customermessage/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'fastscrm/sale/customermessage/destroy',
                                    refresh: true
                                }
                            ],
                            formatter: Table.api.formatter.operate
