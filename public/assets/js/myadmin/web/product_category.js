define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'web/product_category/index' + location.search,
                    add_url: 'web/product_category/add' + (Config.type ? '/type/' + Config.type : '') + location.search,
                    edit_url: 'web/product_category/edit',
                    del_url: 'web/product_category/del',
                    multi_url: 'web/product_category/multi',
                    import_url: 'web/product_category/import',
                    table: 'myadmin_web_product_category',
                },
                        ...
                        { field: 'weigh', width: '80', title: __('Weigh'), operate: false },
                        {
                            ...
                            buttons: [{
                                ...
                                url: function (table, row, index) {
                                    return 'web/product/add?category_id=' + table['id'];
                                }
                            }, {
                                name: 'level',
                                text: function (table, row, index) {
                                ...
                                url: function (table, row, index) {
                                    return 'web/product/index?category_id=' + table['id'];
                                },
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'web/product_category/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                        ...
                        },
                        {
                            ...
                            buttons: [{
                                ...
                                url: 'web/product_category/restore',
                                refresh: true
                            },
                            {
                                name: 'Destroy',
                                ...
                                icon: 'fa fa-times',
                                url: 'web/product_category/destroy',
                                refresh: true
                            }
                            ],
