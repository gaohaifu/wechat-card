define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    var Controller = {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'web/content/index' + location.search,
                    add_url: 'web/content/add' + Controller.params(),
                    edit_url: 'web/content/edit',
                    del_url: 'web/content/del',
                    multi_url: 'web/content/multi',
                    import_url: 'web/content/import',
                    table: 'myadmin_web_article',
                },
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'web/content/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
