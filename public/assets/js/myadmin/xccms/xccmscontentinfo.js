        ...
        fun: {
            BindData: function(t, cid){
                $('#table').bootstrapTable('refresh', {
                    url: 'xccms/xccmscontentinfo/getList?cid=' + cid
                });
            },
        },
        index: function () {
            ...
            Table.api.init({
                extend: {
                    // index_url: 'xccms/xccmscontentinfo/index' + location.search,
                    index_url: 'xccms/xccmscontentinfo/getList?cid=-1',
                    add_url: 'xccms/xccmscontentinfo/add',
                    edit_url: 'xccms/xccmscontentinfo/edit',
                    del_url: 'xccms/xccmscontentinfo/del',
                    table: 'xccms_content_info',
                }
            });
