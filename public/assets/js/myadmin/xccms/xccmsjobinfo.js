define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xccms/xccmsjobinfo/index' + location.search,
                    add_url: 'xccms/xccmsjobinfo/add',
                    edit_url: 'xccms/xccmsjobinfo/edit',
                    del_url: 'xccms/xccmsjobinfo/del',
                    multi_url: 'xccms/xccmsjobinfo/multi',
                    import_url: 'xccms/xccmsjobinfo/import',
                    table: 'xccms_job_info',
                }
            });
