define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'smartcard/category/index' + location.search,
                    add_url: 'smartcard/category/add',
                    edit_url: 'smartcard/category/edit',
                    del_url: 'smartcard/category/del',
                    multi_url: 'smartcard/category/multi',
                    import_url: 'smartcard/category/import',
                    table: 'smartcard_category',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'introtext', title: __('Introtext'), operate: 'LIKE'},
